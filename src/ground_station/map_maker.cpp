...
void MapMaker::addNewInfoToMap(Map * map, Drone * drone, const geometry_msgs::PoseArray & posesInfo) {
  map->addNewPoses(drone, posesInfo);
}

void MapMaker::correctPosesInfo(Drone * drone, geometry_msgs::PoseArray posesInfo) {
